...
<html lang="<?php language_attributes(); ?>">
    ...
    <?php wp_body_open();?>
        ...
        <div id="content" class="site-content">
            <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'mexclusive' ); ?></a>
                ...
                <div class="container px-0">
                    <nav class="navbar navbar-light navbar-expand-xl">
                        ...
                        <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top" role="navigation" aria-label="<?php esc_attr_e('Main navigation', 'mexclusive');?>">
                                <?php
                                        wp_nav_menu(array(
                            ...
                            <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0 is-mobile">
                                <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column ms-2" style="width: 150px;">
                                            <?php
                                                ...
                                                if ( $latest_post ) {
                                                    ...
                                                    echo '<small>' . esc_html__('Last Posts`s date is: ', 'mexclusive') . $formatted_date . '</small>';
                                                } else {
                                                    echo '<small>' . esc_html__('No posts found.', 'mexclusive') . '</small>';
                                                }
                                            ?>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content rounded-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><?php _e('Search by keyword', 'mexclusive'); ?></h5>
